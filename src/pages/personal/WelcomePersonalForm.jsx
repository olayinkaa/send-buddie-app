...
import { useWelcomePersonalProfile, useGetCountries, useTokenRefresh } from "../../react-query";
...
export default function WelcomePersonalForm() {
    const {
        authState: { user },
    } = useAuth();
    const {
    ...
    const { createPersonalProfile, isCreatingPersonalProfile } = useWelcomePersonalProfile({ onSuccess });
    ...
    const handlePersonal = (values) => {
        ...
        createPersonalProfile(requestPayload);
    };
                     ...
                     */}
                        ...
                        <div className="mb-5 flex flex-col">
                            <SendBuddieButton
                                ...
                                isLoading={isCreatingPersonalProfile}
